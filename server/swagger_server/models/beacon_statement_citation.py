...
class BeaconStatementCitation(Model):
    ...
    def __init__(self, id: str=None, uri: str=None, name: str=None, evidence_type: str=None, _date: str=None):  # noqa: E501
        ...
        :param _date: The _date of this BeaconStatementCitation.  # noqa: E501
        :type _date: str
        """
        self.swagger_types = {
            'id': str,
    ...
    @property
    def _date(self) -> str:
        """Gets the _date of this BeaconStatementCitation.

        publication date of annotation (generally of format 'yyyy-mm-dd')   # noqa: E501

        :return: The _date of this BeaconStatementCitation.
        :rtype: str
        """
        return self.__date
    ...
    def _date(self, _date: str):
        """Sets the _date of this BeaconStatementCitation.

        publication date of annotation (generally of format 'yyyy-mm-dd')   # noqa: E501

        :param _date: The _date of this BeaconStatementCitation.
        :type _date: str
        """
