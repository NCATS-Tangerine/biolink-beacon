...
class Concept(Model):
    ...
    def __init__(self, id: str=None, name: str=None, semantic_group: str=None, synonyms: List[str]=None, definition: str=None):  # noqa: E501
        ...
        :type name: str
        :param semantic_group: The semantic_group of this Concept.  # noqa: E501
        :type semantic_group: str
        :param synonyms: The synonyms of this Concept.  # noqa: E501
        :type synonyms: List[str]
        :param definition: The definition of this Concept.  # noqa: E501
        :type definition: str
        """
        self.swagger_types = {
            'id': str,
